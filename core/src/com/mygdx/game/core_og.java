...
public class core_ extends ApplicationAdapter {
	SpriteBatch batch;
	Texture enemy, link;
	BitmapFont font;
	...
	public void render () { //Where the game should be drawn
		...
		walk = new Animation<TextureRegion>(frameDur, walkFrames);
		...
		walk = null; link = null; walkFrames = null;
		System.gc();
	...
	public void draw(){
		...
		batch.draw(enemy, 100, 50);
		batch.draw(enemy, 150, 50);
		batch.draw(enemy, 200, 50);
		batch.draw(enemy, 250, 50);
		batch.draw(enemy, 300, 50);
	...
	public void gameLogic(){
		...
		//oolean getKey = key1.getHitbox().collision(rab.getX(), rab.getY(), 50, 50);
